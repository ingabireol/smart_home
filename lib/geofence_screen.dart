...
class _MapPageState extends State<MapPagez> {
  ...
  bool _isLocationInsideGeofence(double latitude, double longitude) {
    ...
    List<LatLng> aucaBoundaries = [
      const LatLng(-1.955909943471038, 30.10407433017038),
      const LatLng(-1.9558871579775674, 30.10410785778101),
      const LatLng(-1.9559669072033603, 30.104125962690752),
      const LatLng(-1.9559434515491052, 30.104152784779256),
    ];
